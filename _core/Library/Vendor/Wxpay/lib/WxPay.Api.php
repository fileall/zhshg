<?php
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR  . 'WxPay.Exception.php' ;
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR  . 'WxPay.Config.php' ;
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR  . 'WxPay.Data.php' ; 
...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6) 
	{
		...
		$startTimeStamp = self::getMillisecond();//请求开始时间 毫秒级时间搓
	...
	{		
		...
		curl_setopt($ch,CURLOPT_SSL_VERIFYPEER,FALSE); //ssl 错误， 改为false
