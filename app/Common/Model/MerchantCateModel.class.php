...
class MerchantCateModel extends RelationModel {
    ...
    protected $_link = array(
        ...
        'at_list' => array(
            ...
            'class_name' => 'Article',
            'foreign_key' => 'cate_id',
            'mapping_fields' => 'id,title,add_time',
            'condition' => 'status = 1',
            'mapping_limit' => 5,
            'mapping_order' =>'ordid,id desc'
        ),'self' => array(
            'mapping_type'  => self::HAS_MANY,
            'class_name'    => 'MerchantCate',
            'parent_key'   => 'pid',
            'condition' => 'status = 1',
    ...
    public function cate_cache() {
        ...
        F('merchant_cate_list', $artcate_list);
        return $artcate_list;
    }
