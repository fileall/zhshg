...
<title><?php echo L('website_manage');?></title>
	...
	var URL = '/jradmin.php/item_cate';

	var SELF = '/jradmin.php?m=admin&c=item_cate&a=index&menuid=56';
...
<div class="pad_lr_10">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="J_cate_tree">
        <tr>
            ...
            <th class="tl"><?php echo L('item_cate_name');?></th>
            <th><!--Wap-->分类图片</th>
            <!--<th>Wap首页小图标</th>
            <th>Pc分类图片</th>
            <th>Pc首页小图标</th>-->
			...
			<th><span data-tdtype="order_by" data-field="is_home">首页显示</span></th>
