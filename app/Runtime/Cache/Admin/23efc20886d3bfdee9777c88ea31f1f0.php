...
<title><?php echo L('website_manage');?></title>
	...
	var URL = '/jradmin.php/search_keywords';

	var SELF = '/jradmin.php?m=admin&c=search_keywords&a=index&menuid=528';
...
<div class="pad_lr_10">
    ...
    <div class="J_tablelist table_list" data-acturi="<?php echo U('SearchKeywords/ajax_edit');?>">
        <table width="100%" cellspacing="0">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center">
                    <a href="javascript:;" class="J_showdialog" data-uri="<?php echo U('SearchKeywords/edit', array('id'=>$val['id']));?>" data-title="<?php echo L('edit');?>"  data-id="edit" data-width="450" data-height="100"><?php echo L('edit');?></a> | <a href="javascript:void(0);" class="J_confirmurl" data-acttype="ajax" data-uri="<?php echo u('SearchKeywords/delete', array('id'=>$val['id']));?>" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['keywords']);?>"><?php echo L('delete');?></a>
                </td>
    ...
    <div class="btn_wrap_fixed">
    	...
    	<input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('SearchKeywords/delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
