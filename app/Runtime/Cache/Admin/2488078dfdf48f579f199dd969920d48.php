...
<title><?php echo L('website_manage');?></title>
	...
	var SELF = '/jradmin.php?m=admin&c=item&a=add&menuid=249';
			...
			<div class="J_panes">
				<div class="content_list pad_10">
					<table width="100%" cellspacing="0" class="table_form">
						...
						<tr>
							...
							<td>
								<select name="brand_id" >
									...
									<?php if(is_array($brand_list)): $i = 0; $__LIST__ = $brand_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($val); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</td>
						</tr>
						...
						<tr>
							<th>商城价格 :</th>
							<td><input type="text" id="J_price" name="price" size="20" class="input-text" ></td>
						</tr>
						<tr>
							<th>商品库存:</th>
							<td><input type="text" name="inventory" size="20" class="input-text" ></td>
						</tr>
						<tr>
							<th>原价 :</th>
							<td><input type="text" name="oldprice" size="20" class="input-text" ></td>
						</tr>
						<tr>
							<th>销量 :</th>
							<td><input type="text" name="sales" size="20" class="input-text" ></td>
						</tr>
						<tr>
							<th>金果商城 :</th>
							<td>
								<input type="radio" name="is_fruit" value="1" />加入
								<input type="radio" name="is_fruit" value="0" checked />不加入
							</td>
						</tr>
             		    <tr>
							<th>商品标签 :</th>
							<td>
								<input name="fx" type="checkbox" value="1" />发现好货
								<input name="zhm" type="checkbox" value="1" />臻会买专辑  
								<input name="jx" type="checkbox" value="1" />臻怡家精选
								<!--<input name="jx" type="radio" value="1" />臻怡家精选-->
							</td>
						</tr>
						<!--<tr>-->
							<!--<th>收银类型 :</th>-->
							<!--<td>-->
								<!--<input name="zftype[]" type="checkbox" value="1" />元宝-->
								<!--<input name="zftype[]" type="checkbox" value="2" />金果-->
								<!--<input name="zftype[]" type="checkbox" value="3" />云宝+金币-->
							<!--</td>-->
						<!--</tr>-->
						<!--<tr>-->
							<!--<th>放入金果商城:</th>-->
							<!--<td>-->
								<!--<label><input type="radio" name="tj" class="radio_style" value="1" > <?php echo L('yes');?> </label>&nbsp;&nbsp;-->
								<!--<label><input type="radio" name="tj" class="radio_style" value="0" > <?php echo L('no');?></label>-->
							<!--</td>-->
						<!--</tr>-->
						<tr>
							<th>详细内容 :</th>
					...
					<table width="100%" cellpadding="2" cellspacing="1" class="table_form" id="item_attr">
						...
						<tr>
							<td align="left">
								...
								价格 : <input type="text" name="attr[price][]" class="input-text xx" size="8">
