...
<title><?php echo L('website_manage');?></title>
	...
	var SELF = '/jradmin.php?m=admin&c=article&a=add&menuid=157';
			...
			<div class="content_list pad_10">
				<table width="100%" cellspacing="0" class="table_form">
					<tr>
						...
						<td><select class="J_cate_select mr10" data-pid="0" data-uri="<?php echo U('article_cate/ajax_getchilds');?>" data-selected="2"></select>
		            ...
		            <tr>
						...
						<td>
					        ...
					        <a href="javascript:;" class="color_picker_btn"><img class="J_color_picker" data-it="J_title" data-ic="J_color" src="/theme/admin//images/color.png"></a>
		                </td>
					</tr>
		            <tr>
						<th>详细内容 :</th>
