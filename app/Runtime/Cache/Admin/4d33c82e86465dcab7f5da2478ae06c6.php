...
<title><?php echo L('website_manage');?></title>
	...
	var URL = '/jradmin.php/merchant_cate';

	var SELF = '/jradmin.php?m=admin&c=merchant_cate&a=index&menuid=334';
...
<div class="pad_lr_10">
    ...
    <div class="J_tablelist table_list" data-acturi="<?php echo U('MerchantCate/ajax_edit');?>">
    ...
    <div class="songkebor">
        ...
        <!--<input type="button" class="btn btn_submit" data-tdtype="batch_action" data-acttype="ajax_form" data-id="move" data-uri="<?php echo U('member_cate/move');?>" data-name="id" data-title="<?php echo L('item_cate_move');?>" value="<?php echo L('move');?>" />--> 

        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('MerchantCate/delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
