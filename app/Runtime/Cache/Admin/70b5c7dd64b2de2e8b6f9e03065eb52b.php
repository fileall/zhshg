...
<title><?php echo L('website_manage');?></title>
	...
	var SELF = '/jradmin.php?m=admin&c=member&a=upgrade&menuid=474';
...
<div class="pad_lr_10">
        ...
        <tbody>
            <tr>
                ...
                <div class="explain_col">
                    ...
                    &nbsp;&nbsp;升级日期：<input type="text" name="time_start" id="J_time_start" class="date" value="<?php echo ($search["time_start"]); ?>" placeholder="时间开始">
                    -
                    <input type="text" name="time_end" id="J_time_end" class="date"  value="<?php echo ($search["time_end"]); ?>" placeholder="时间截止"> 
                    &nbsp;&nbsp;关键字 :
                    <input name="keywords" type="text" class="input-text"  value="<?php echo ($search["keywords"]); ?>" placeholder="会员名/手机号码" />
                    <input type="submit"  class="btn" value="搜索" />
                    <input type="button"  class="btn export_sj" value="下载报表" />
    ...
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
                ...
                <th>会员名</th>
                <th>手机号</th>
                <th><span data-tdtype="order_by" data-field="totalprices">升级金额</span></th>
                <th><span data-tdtype="order_by" data-field="old_vip">升级前级别</span></th>
                <th><span data-tdtype="order_by" data-field="after_vip">升级后级别</span></th>
                <th><span data-tdtype="order_by" data-field="zftype">支付方式</span></th>
                <th align="left"><span data-tdtype="order_by" data-field="add_time">升级时间</span></th>
    	...
    	<tbody>
        	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center"><?php echo ($val['old_vip']); ?></td>
                <td align="center"><?php echo ($val['after_vip']); ?></td>
                <td align="center"><?php echo ($val['zftype']); ?></td>
    ...
    <div class="btn_wrap_fixed">
       ...
       <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('withdraw/');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="驳回" />
...
<script>
    ...
    $(".export_sj").click(function(){
        $("input[name='a']").val("export_sj");
        $("form").submit();
    })
</script>
</html>