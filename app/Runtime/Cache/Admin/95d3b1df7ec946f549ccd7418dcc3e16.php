...
<title><?php echo L('website_manage');?></title>
	...
	var URL = '/jradmin.php/withdraw_qd';

	var SELF = '/jradmin.php?m=admin&c=withdraw_qd&a=index&menuid=523';
        ...
        <tbody>
            <tr>
                ...
                <div class="explain_col"> 
                    ...
                    &nbsp;&nbsp;关键字 :
                    <input name="keywords" type="text" class="input-text"  value="<?php echo ($search["keywords"]); ?>" placeholder="手机" />
    ...
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
        	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <!--<td align="center"><?php echo ($val[""]); ?></td>&lt;!&ndash;关联查询merchant&ndash;&gt;-->
                <td align="center"><?php echo ($val["member_name"]); ?></td>
                 <td align="center"><?php echo ($val["mobile"]); ?></td> <!--关联查询merchant-->
                 <td align="center"><?php echo ($val["province"]); ?></td>
                 <td align="center"><?php echo ($val["city"]); ?></td>
                <td align="center"><?php echo ($val["name"]); ?>-<?php echo ($val["title"]); ?></td>
                ...
                <td align="center">
                    <?php if($val['status'] == 1): ?><a href="javascript:;" class="J_confirmurl" data-acttype="ajax" data-uri="<?php echo U('WithdrawQd/sh', array('id'=>$val['id'],'status'=>1));?>" data-msg="确认通过吗?" style="color:#F76741;">通过</a>
                        |<a href="javascript:;" class="J_confirmurl" data-acttype="ajax" data-uri="<?php echo U('WithdrawQd/sh', array('id'=>$val['id'],'status'=>2));?>" data-msg="确认驳回吗?" style="color:#F76741;">驳回</a>
