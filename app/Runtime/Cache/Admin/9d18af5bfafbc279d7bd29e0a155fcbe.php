...
<title><?php echo L('website_manage');?></title>
	...
	var URL = '/jradmin.php/bank_img';

	var SELF = '/jradmin.php?m=admin&c=bank_img&a=index&menuid=530';
...
<!--角色管理-->
<div class="pad_lr_10">
    <div class="J_tablelist table_list" data-acturi="<?php echo U('BankImg/ajax_edit');?>">
        <table width="100%" cellspacing="0">
            <thead>
            <tr>
                <th width="40"><input type="checkbox" name="checkall" class="J_checkall"></th>
                <th width="60">ID</th>
                <th align="left" width="200">银行名称</th>
                <th width="180">头像</th>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td align='center'><input type='checkbox' value='<?php echo ($vo["id"]); ?>' class='J_checkitem'></td>
                    <td align='center'><?php echo ($vo["id"]); ?></td>
                    <td align='center'><?php echo ($vo["name"]); ?></td>
                    <td align='center'><img src="<?php echo attach($vo['img'],'bank_img');?>" width="100" height="100"/></td>
                    <td align="center">
                        <a href="javascript:;" class="J_showdialog" data-uri="<?php echo U('BankImg/edit', array('id'=>$vo['id']));?>" data-title="<?php echo L('edit');?> - <?php echo ($vo["name"]); ?>"  data-id="edit" data-width="550" data-height="90"><?php echo L('edit');?></a> |
                        <a href="javascript:;" class="J_confirmurl" data-acttype="ajax" data-uri="<?php echo U('BankImg/delete', array('id'=>$vo['id']));?>" data-msg="<?php echo sprintf(L('confirm_delete_one'),$vo['name']);?>"><?php echo L('delete');?></a>
                    </td>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('bank/delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
