...
<title><?php echo L('website_manage');?></title>
	...
	var URL = '/jradmin.php/buy_send';

	var SELF = '/jradmin.php?m=admin&c=buy_send&a=index&menuid=520';
...
<!--商品列表-->
<div class="pad_lr_10" >
    <div class="J_tablelist table_list" data-acturi="<?php echo U('buy_send/ajax_edit');?>">
    <table width="100%" cellspacing="0">
            <tr>
                <th width="20"><input type="checkbox"  name="checkall" class="J_checkall"></th>
                <th><span data-tdtype="order_by" data-field="id">ID</span></th>
                <th>充值金额</th>
                <th><span data-tdtype="order_by" data-field="send_coin">赠送银币个数</span></th>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center"><span data-tdtype="edit" data-field="money" data-id="<?php echo ($val["id"]); ?>" class="tdedit" style="color:<?php echo ($val["colors"]); ?>;"><?php echo ($val["money"]); ?></span></td>
                <td align="center"><span data-tdtype="edit" data-field="send_coin" data-id="<?php echo ($val["id"]); ?>" class="tdedit" style="color:<?php echo ($val["colors"]); ?>;"><?php echo ($val["send_coin"]); ?></span></td>
    ...
    <!--<div class="songkebor">-->
        ...
        <!--<input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('buy_send/delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="批量删除" />-->
