...
<title><?php echo L('website_manage');?></title>
	...
	var URL = '/jradmin.php/withdraw_member';

	var SELF = '/jradmin.php?m=admin&c=withdraw_member&a=index&menuid=463';
...
<div class="pad_lr_10">
    ...
    <div class="J_tablelist table_list" data-acturi="<?php echo U('WithdrawMember/ajax_edit');?>">
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
        	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center"><?php echo ($val["service_charge"]); ?></td>
                <td align="center"><?php echo date('Y-m-d H:i' ,$val['add_time']);?></td>
                <td align="center">
                <?php if($val['status'] == 1): ?><a href="javascript:;" class="J_confirmurl" data-acttype="ajax" data-uri="<?php echo U('WithdrawMember/sh', array('id'=>$val['id'],'status'=>1));?>" data-msg="确认通过吗?" style="color:#F76741;">通过</a>
                         |<a href="javascript:;" class="J_confirmurl" data-acttype="ajax" data-uri="<?php echo U('WithdrawMember/sh', array('id'=>$val['id'],'status'=>2));?>" data-msg="确认驳回吗?" style="color:#F76741;">驳回</a>
