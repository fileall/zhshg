...
<div class="dialog_content">
	...
	<table width="100%" class="table_form">
		<tr> 
			...
			<td>
				<select class="J_cate_select mr10" data-pid="0" data-uri="<?php echo U('article_cate/ajax_getchilds');?>" data-selected="<?php echo ($spid); ?>"></select>
...
$(function(){
    ...
    $("#name").formValidator({ onShow: "请输入名称", onfocus: "请输入名称", onCorrect: "输入正确" }).inputValidator({min:1,onerror:'请输入名称'}).defaultPassed();
