...
<title><?php echo L('website_manage');?></title>
	...
	var SELF = '/jradmin.php?m=admin&c=service&a=edit&id=70&menuid=459';
...
<!--编辑区代-->
<form id="info_form" action="<?php echo u('service/edit');?>" method="post" enctype="multipart/form-data">
	<div class="pad_lr_10">
		<div class="col_tab">
			...
			<div class="J_panes">
				<div class="content_list pad_10">
					<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
						...
						<tr>
							<th>真实姓名 :</th>
							<td><?php echo ($info["realname"]); ?>
								<?php if(empty($info['realname'])): ?>未设置<?php endif; ?>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								...
								<?php if(empty($info['id_nums'])): ?>未设置
								<?php else: ?>
									<?php echo ($info["id_nums"]); endif; ?>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								...
								<input type="hidden" name="cate_id" id="place_id" value="<?php echo ($info['cate_id']); ?>" />
							</td>
						</tr>
						<tr>
							<th>头像 :</th>
