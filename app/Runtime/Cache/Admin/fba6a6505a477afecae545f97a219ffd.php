...
<title><?php echo L('website_manage');?></title>
	...
	var URL = '/jradmin.php/admin';

	var SELF = '/jradmin.php?m=admin&c=admin&a=index&menuid=435';
    ...
    <div class="J_tablelist table_list" data-acturi="<?php echo U('admin/ajax_edit');?>">
        <table width="100%" cellspacing="0">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <!--<td align="center"><?php echo ($val["place"]["name"]); ?></td>-->
                ...
                <td align="center">
                    <a href="javascript:;" class="J_showdialog" data-uri="<?php echo U('admin/edit', array('id'=>$val['id']));?>" data-title="<?php echo L('edit');?> - <?php echo ($val["username"]); ?>"  data-id="edit" data-width="530" data-height="210"><?php echo L('edit');?></a> |
