...
<head>
	...
	<!--var SELF = '/index.php?s=/index/exploit.html';-->
	<!--var ROOT_PATH = '';-->
	<!--var APP	 =	 '/index.php?s=';-->
	<!--//语言项目-->
	<!--var lang = new Object();-->
	...
	<body class="body-bgColor">
		...
		<div class="header-wrap">
			<div class="header-inner">
				<div class="header-title">正在开发中</div>
		...
		<div class="content">
			...
			<div class="null-wrap vertical-center">
				<div class="vertical-auto">
					<div class="null-page">
						<div class="null-page-icon"><img src="/theme/mobile/images/icon79.png"></div>
						<div class="null-page-txt">正在开发中！</div>
						<div class="null-page-link"><a href="<?php echo U('index/index');?>">返回首页</a></div>
					</div>
				</div>
			</div>
			<!--空购物车-->
