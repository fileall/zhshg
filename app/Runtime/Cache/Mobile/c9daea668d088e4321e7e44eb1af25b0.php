...
<head>
	...
	<!--var SELF = '/index.php?s=/Index/about/type/1.html';-->
	<!--var ROOT_PATH = '';-->
	<!--var APP	 =	 '/index.php?s=';-->
	<!--//语言项目-->
	<!--var lang = new Object();-->
...
<body class="body-bgColor">
    ...
    <div class="header-wrap">
        <div class="header-inner">
            <div class="header-title"><?php echo ($list['title']); ?></div>
    ...
    <!--content-->
    <div class="content">
        <div class="y-width94 y-color-999 y-help font-28"><?php echo code2html($list['info']);?></div>
    </div>
    <!--content-->
