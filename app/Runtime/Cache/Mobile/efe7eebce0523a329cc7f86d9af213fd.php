...
<head>
	...
	<!--var SELF = '/index.php?s=/index/new_list.html';-->
	<!--var ROOT_PATH = '';-->
	<!--var APP	 =	 '/index.php?s=';-->
	<!--//语言项目-->
	<!--var lang = new Object();-->
	...
	<body class="body-bgColor">
		...
		<div class="content">
			<ul class="message-list-ul">
				<?php if(is_array($new_list)): $i = 0; $__LIST__ = $new_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><li class="message-list <?php if($new['is_read'] != 1): ?>active<?php endif; ?>"><!--未读消息-->
						<a href="<?php echo U('index/new_details',array('id'=>$new['id']));?>">
							<div class="row-box">
								<div class="message-list-left">●</div>
								<div class="row-flex">
									<div class="message-list-txt"><?php echo ($new["title"]); ?></div>
								</div>
								<div class="message-list-date"><?php echo date('Y-m-d',$new['add_time']);?></div>
							</div>
						</a>
